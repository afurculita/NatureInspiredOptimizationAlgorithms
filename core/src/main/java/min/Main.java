...
import min.algorithm.GrienwangkAlgorithm;
import min.algorithm.RastriginAlgorithm;
import min.algorithm.RosenbrockAlgorithm;
import min.algorithm.SixHumpCamelBackAlgorithm;
import min.genetic.GeneticAlgorithmExecution;
import min.hillclimbing.HillClimbingExecution;
import min.hybrid.HybridAlgorithmExecution;
